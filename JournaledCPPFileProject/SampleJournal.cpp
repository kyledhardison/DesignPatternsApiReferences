...
int main()
{
    ...
    Part1->Save();
    AutomationAPI::Part* Part2 = mySession->OpenPart("C:\\Users\\jpbro\\Documents\\develop\\SoftwareArch\\repositories\\SoftwareArchitectureCLassApplication\\SampleVersionUp.prt");
    Part2->Save();
